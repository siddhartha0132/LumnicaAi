...
USER ANSWERS (from personalized questions):
${answers.map((ans, idx) => `Q${idx + 1}: ${ans}`).join('\n')}

TASK:
1. Determine the user's Ayurvedic Dosha type
2. Create personalized skin profile
3. Design morning, night, and weekly skincare routines
4. Recommend products (optional - may be empty)
5. Provide lifestyle advice

STRICT OUTPUT FORMAT (JSON ONLY):
{
  "dosha": {
    "type": "Dosha type here",
    "description": "Description of dosha and skin manifestation"
  },
  "skinProfile": {
    "tone": "skin tone",
    "type": "skin type",
  ...
  "routine": {
    "morning": [
      { "step": "Step name", "product": "Product name", "reason": "Why this helps" }
    ],
    "night": [
      { "step": "Step name", "product": "Product name", "reason": "Why this helps" }
    ],
  ...
  "products": [],
  "doshaInsights": "Lifestyle and dietary advice based on dosha"
}`;
